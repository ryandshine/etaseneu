...
export const KAWASAN_HUTAN_LEGEND: ReadonlyArray<{ label: string; color: string }> = [
  { label: "Kawasan Konservasi", color: "#AD3FFF" },
  { label: "Hutan Lindung", color: "#02AD00" },
  { label: "Hutan Produksi Terbatas", color: "#8AF200" },
  { label: "Hutan Produksi Tetap", color: "#FFFF00" },
  { label: "HP dapat Dikonversi", color: "#FF5EFF" },
  { label: "Areal Penggunaan Lain", color: "#FFFFFF" },
