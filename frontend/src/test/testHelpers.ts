...
// tiap test file harus meng-handle POST /api/auth/login dengan {ok:true}
// tanpa syarat -- ini cuma melewati gerbangnya, bukan menguji login itu
// sendiri (itu sudah dites di backend & di test khusus login kalau ada).
